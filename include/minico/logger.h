...
// 私有
#define LOG_BASE(level, to_abort, fmt, ...) log_base(__FILE__, __LINE__, level, to_abort, fmt, ##__VA_ARGS__)
#define LOG_SYS(to_abort, fmt, ...) log_sys(__FILE__, __LINE__, to_abort, fmt, ##__VA_ARGS__)
